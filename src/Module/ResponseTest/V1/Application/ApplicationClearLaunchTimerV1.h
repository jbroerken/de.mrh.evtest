...
#ifndef ApplicationClearLaunchTimerV1_h
#define ApplicationClearLaunchTimerV1_h
...
class ApplicationClearLaunchTimerV1 : public EventModule
{
public:
    ...
    ApplicationClearLaunchTimerV1(bool& b_EventFailed) noexcept : EventModule("ApplicationClearLaunchTimerV1",
                                                                              b_EventFailed)
    {
        ...
        catch (...)
        {
            MRH::AB::ModuleLogger::Singleton().Log(GetName(), "Failed to add user event!", 
                                                   "ApplicationClearLaunchTimerV1.h", __LINE__);
    ...
    ~ApplicationClearLaunchTimerV1() noexcept
    {}
...
private:
    ...
    {
        return (u32_Type == MRH_EVENT_APP_LAUNCH_SOA_CLEAR_TIMER_S);
    }
...
#endif /* ApplicationClearLaunchTimerV1_h */
