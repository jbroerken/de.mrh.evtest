...
#ifndef ApplicationV1Response_h
#define ApplicationV1Response_h
...
class ApplicationV1Response : public MRH::AB::Module
{
public:
    ...
    ApplicationV1Response(bool& b_EventFailed) noexcept;
    
    /**
     *  Default destructor.
     */
    
    ~ApplicationV1Response() noexcept;
