...
#ifndef SayGetMethodV1_h
#define SayGetMethodV1_h
...
class SayGetMethodV1 : public EventModule
{
public:
    ...
    SayGetMethodV1(bool& b_EventFailed) noexcept : EventModule("SayGetMethodV1",
                                                               b_EventFailed)
    {
...
private:
    ...
    {
        return (u32_Type == MRH_EVENT_SAY_GET_METHOD_S);
    }
