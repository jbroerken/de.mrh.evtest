...
#ifndef UserV1Response_h
#define UserV1Response_h
...
class UserV1Response : public MRH::AB::Module
{
public:
    ...
    UserV1Response(bool& b_EventFailed) noexcept;
    
    /**
     *  Default destructor.
     */
    
    ~UserV1Response() noexcept;
