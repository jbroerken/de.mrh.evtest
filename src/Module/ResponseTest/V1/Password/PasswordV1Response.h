...
#ifndef PasswordV1Response_h
#define PasswordV1Response_h
...
class PasswordV1Response : public MRH::AB::Module
{
public:
    ...
    PasswordV1Response(bool& b_EventFailed) noexcept;
    
    /**
     *  Default destructor.
     */
    
    ~PasswordV1Response() noexcept;
