...
#ifndef CustomV1Response_h
#define CustomV1Response_h
...
class CustomV1Response : public MRH::AB::Module
{
public:
    ...
    CustomV1Response(bool& b_EventFailed) noexcept;
    
    /**
     *  Default destructor.
     */
    
    ~CustomV1Response() noexcept;
