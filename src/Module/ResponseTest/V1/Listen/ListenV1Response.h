...
#ifndef ListenV1Response_h
#define ListenV1Response_h
...
class ListenV1Response : public MRH::AB::Module
{
public:
    ...
    ListenV1Response(bool& b_EventFailed) noexcept;
    
    /**
     *  Default destructor.
     */
    
    ~ListenV1Response() noexcept;
