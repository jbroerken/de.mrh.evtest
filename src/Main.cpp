...
// Project
#include "./Module/ResponseTest/ResponseTest.h"
#include "./Revision.h"
...
extern "C"
{
    ...
    int MRH_Init(const char* p_LaunchInput, int i_LaunchCommandID)
    {
        ...
        c_Logger.Log("MRH_Init", "Initializing Event Test application (Version: " +
        ...
        try
        {
            p_Context = new MRH::AB::Context(std::make_unique<ResponseTest>());
            return 0;
        }
