...
#ifndef U_GetLocation_V1_h
#define U_GetLocation_V1_h
...
// Project
#include "./U_Custom_V1.h"


class U_GetLocation_V1 : public EventModule
{
public:
    ...
    U_GetLocation_V1(std::shared_ptr<EventSender>& p_EventSender) : EventModule("MRH_EVENT_USER_GET_LOCATION",
                                                                                ...
                                                                                p_EventSender)
    {
        ...
        if (p_Event == NULL)
        {
            throw MRH::AB::ModuleException(GetIdentifier(),
                                           "Failed to create MRH_EVENT_USER_GET_LOCATION_U event!");
        }
    ...
    {
        return std::make_unique<U_Custom_V1>(p_EventSender);
    }
