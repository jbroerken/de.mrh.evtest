...
#ifndef S_GetMethod_V1_h
#define S_GetMethod_V1_h
...
// Project
#include "./S_NotificationApp_V1.h"


class S_GetMethod_V1 : public EventModule
{
public:
    ...
    S_GetMethod_V1(std::shared_ptr<EventSender>& p_EventSender) : EventModule("MRH_EVENT_SAY_GET_METHOD",
                                                                              MRH_EVENT_SAY_GET_METHOD_S,
                                                                              false,
                                                                              p_EventSender)
    {
        MRH_Event* p_Event = MRH_EVD_CreateEvent(MRH_EVENT_SAY_GET_METHOD_U, NULL, 0);

        if (p_Event == NULL)
        {
            throw MRH::AB::ModuleException(GetIdentifier(),
                                           "Failed to create MRH_EVENT_SAY_GET_METHOD_U event!");
        }
    ...
    {
        return std::make_unique<S_NotificationApp_V1>(p_EventSender);
    }
