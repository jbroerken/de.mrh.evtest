...
// Pre-defined
#ifndef MRH_EVENT_TEST_CHECK_PASSWORD
    #define MRH_EVENT_TEST_CHECK_PASSWORD "password"
#endif


class P_Check_V1 : public EventModule
{
public:
    ...
    P_Check_V1(std::shared_ptr<EventSender>& p_EventSender) : EventModule("MRH_EVENT_PASSWORD_CHECK",
                                                                          ...
                                                                          p_EventSender)
    {
        ...
        strncpy(c_Data.p_String, MRH_EVENT_TEST_CHECK_PASSWORD, MRH_EVD_P_STRING_BUFFER_MAX);
        ...
        if (p_Event == NULL)
        {
            throw MRH::AB::ModuleException(GetIdentifier(),
                                           "Failed to create MRH_EVENT_PASSWORD_CHECK_U event!");
        }
